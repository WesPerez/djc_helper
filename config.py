...
class FunctionSwitchesConfig(ConfigInterface):
    def __init__(self):
        ...
        # 是否领取 助手能量之芽 活动
        self.get_dnf_helper_energy_tree = True
        # 是否领取 回流引导秘籍 活动
        ...
        # 是否领取 共赴西装节 活动
        self.get_dnf_suit = True
        # 是否领取 助手限定活动 活动
        self.get_dnf_helper_limit_act = True
        # 是否领取 周年庆网吧集结 活动
        ...
        # 是否领取 挑战世界记录 活动
        self.get_dnf_challenge_world_record = True
        # 是否领取 vp挑战赛 活动
        ...
        # 是否领取 助手限定活动_3 活动
        self.get_dnf_helper_limit_act_3 = True
        # 是否领取 夏日礼包 活动
        self.get_dnf_summer_gift_act = True
